...
import com.luthfirrohman.newspedia.core.viewmodel.ViewModelFactory
import com.luthfirrohman.newspedia.databinding.FragmentNewsBinding
import com.luthfirrohman.newspedia.core.data.Result
                ...
                if (result != null) {
                    when (result) {
                        ...
                        is Result.Error -> {
                            ...
                            Toast.makeText(
                                context,
                                "Kesalahan Terjadi : " + result.error,
                                Toast.LENGTH_SHORT
                            ).show()
                        }
                    }
